        ...
        <p className='text-lg'>HCI分野で,プログラミングをより楽しくするための研究をしています．</p>
          ...
          <h3 className='text-xl font-bold'>発表文献</h3>
            ...
            <ol className='list-decimal list-inside mx-3 text-lg'>
              <li>岡 大貴, 寺田 努, 塚本昌彦: プロジェクションマッピングによる読書体験の拡張, ユビキタス・ウェアラブルワークショップ2018論文集, p.26 (Dec. 2018).</li>
              ...
              <li>岡 大貴, 西田健志: 競技性・観戦性を拡張したプログラミングゲームの提案, エンタテインメントコンピューティングシンポジウム2020論文集, Vol. 2020, pp.166--169 (Sep. 2020).</li>
              <li>岡 大貴, 大西鮎美, 寺田 努, 塚本昌彦: マルチモーダル情報を用いたプログラミング時のつまずき検出手法の検討, ユビキタス・ウェアラブルワークショップ2021論文集, Vol.2021, p.36 (Dec. 2021).</li>
              <li>岡 大貴, 大西鮎美，寺田 努, 塚本昌彦: マルチモーダル情報を用いたプログラミング時のつまずき検出手法の提案, 研究報告ヒューマンコンピュータインタラクション (HCI), Vol. 2022, No. 9, pp. 1–7
(Mar. 2022).</li>
            <li>岡 大貴, 大西鮎美, 寺田 努, 塚本昌彦: プログラミング演習授業のためのつまずき検出システムの実運用, ユビキタス・ウェアラブルワークショップ2022論文集, Vol.2022, p.20 (Dec. 2022).</li>
          </ol>
