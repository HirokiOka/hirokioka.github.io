...
export default function SlashShot() {
  ...
  const projectDescription = "プログラミングは魅力的です．コンピュータに向かって試行錯誤しながら，思考をプログラミング言語で表現するプログラマの姿は格好良く，憧れるものです．しかし，プログラミングを経験したことのない人にとって，プログラマの格好良さは伝わりづらいです．プログラミングの魅力は自分でプログラミングをしてみなければ感じづらく，最初から楽しさを感じやすいゲームやスポーツとは違い，プログラミングの楽しさは習熟が進むまで実感することが難しいです．また，プログラマが実際にプログラミングしている様子を見る機会は少ないため，未経験者がプログラミングという行為をイメージしづらいことも格好良さが伝わりづらい原因です．\n\n我々はこれまで，プログラマ同士がプログラミングでキャラクタを制御し戦う対戦型プログラミングゲーム (LiveCodeSTG) を開発し，習熟したプログラマの凄さを可視化することで，初学者の興味喚起を目指してきました．しかし，このゲームは習熟したプログラマが実際にJavaScriptプログラムを記述して対戦するものであり，初学者や未経験者が実際にプレイすることは難しく，プログラマ同士の高度なプログラムを見ることで逆にプログラミングの難しさを感じてしまうという課題がありました．\n\nそこで，このプロジェクトでは，プログラミング経験者にプログラミングの格好良さについてアンケート調査を行い，プログラミングの格好良さを要素化しました．そして，この要素を未経験者でも体感できるように対戦型プログラミングゲームとして実装し，システムを体験型展示として運用しています．提案システムは，テキストベースのプログラミング言語でプレイさせるのではなく，機能を絞ったブロックベースのプログラミングインタフェースを備えています．\n\n";
  const otherLinks = [
    {
      "title": "article",
